...
// //       {/* Left Panel */}
// //       <div className="w-full lg:w-1/2 bg-gradient-to-br from-[#1a2f1a] via-[#1e3d1e] to-[#0d1f0d] relative overflow-hidden flex">
// //         {/* Background Pattern */}
...
// //               <span className="text-xl sm:text-2xl font-normal text-[#4ade80]">Partners</span>
// //             </div>
// //           </div>
...
// //               <span className="text-[#4ade80]">Referral Dashboard</span>
// //             </h1>
...
// //                   className="block w-full pl-11 pr-4 py-3 bg-white border border-gray-300 rounded-md text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 transition-all"
// //                   required
// //                 />
// //               </div>
// //             </div>
...
// //                   className="block w-full pl-11 pr-12 py-3 bg-white border border-gray-300 rounded-md text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 transition-all"
// //                   required
// //                 />
// //                 <button
// //                   type="button"
...
// //             <button
// //               type="submit"
// //               className="w-full bg-[#4ade80] text-gray-900 py-3 px-4 rounded-md text-base font-semibold hover:bg-[#3ec972] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all flex items-center justify-center gap-2 mt-6"
// //             >
// //               Log In
...
// //                 className="text-gray-900 hover:text-green-600 font-semibold transition-colors"
// //               >
// //                 Apply for Access
// //               </button>
// //             </p>
